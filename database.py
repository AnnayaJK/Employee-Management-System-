...
def connect_database():
    ...
    try:
        conn=pymysql.connect(host='localhost',user='root',password='Rash@1234')
    ...
    mycursor.execute('CREATE TABLE IF NOT EXISTS data(Id VARCHAR(20),Name VARCHAR(50),Phone VARCHAR(10),Role VARCHAR(50),Gender VARCHAR(10),Salary DECIMAL(10,2))')
